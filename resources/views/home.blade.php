...
<html lang="en">
    ...
    <body>
        ...
        <section id="hero">
            <div class="container">
                <div class="row">
                    ...
                    <div
                        class="col-6 d-flex justify-content-center align-items-end hero-img"
                    >
                        <img
        ...
        <section id="about">
            <div class="container">
                <div class="d-flex justify-content-center">
                    ...
                    <img
                        src="{{ asset('img/about-sajadah.png') }}"
                        alt=""
                        width="300px"
                    />
                </div>
        ...
        <section id="collection">
            <div class="container text-center">
                ...
                <div class="row">
                    ...
                    <div class="col-4">
                        <img
                            src="{{ asset('img/sajadah-travel.png') }}"
                            alt=""
                            width="100%"
                        />
                    </div>
                ...
                <div class="row comment-group d-flex justify-content-center">
                    <div class="col-3 comment-list">
                        <div class="d-flex comment">
                            <img
                                src="{{ asset('img/person/person-1.png') }}"
                                alt=""
                                width="60px"
                            />
        ...
        <section id="collection">
            <div class="container">
                <div
                    class="collection-header d-flex justify-content-between align-items-center"
                >
                    <h4>Sujud Collection</h4>
                    <p>View All</p>
                </div>
                <div class="collection-body">
                    <p>
                        Begin your journey. Experience the threads of history
                        woven into the present. Discover your unique story with
                        the Sambas Collection.
                    </p>
        ...
        <section id="favorite">
            <div class="container">
                <div class="row">
                    <div
                        class="col-3 produk-group-left text-center d-flex flex-column justify-content-center"
                    >
                        <h4>Favorite Item</h4>
                        <h5>Buy Now</h5>
                        <button>More</button>
        ...
        <section id="seen">
            <div class="container text-center">
                ...
                <div class="row image-group">
                    ...
                    <div
                        class="col-4 sponsor-list d-flex flex-column justify-content-center align-items-center"
                    >
                        <img
                            src="{{ asset('img/logo/liputan-6.png') }}"
                            alt=""
                        />
                    </div>
                    <div class="col-4 sponsor-list">
                        <img
                            src="{{ asset('img/logo/tribun-news.jpg') }}"
                            alt=""
                        />
                    </div>
                </div>
                <div class="row image-group">
                    <div
                        class="col-4 sponsor-list d-flex align-items-center justify-content-center"
                    >
                        <img
                            src="{{ asset('img/logo/kumparan.png') }}"
                            alt=""
                        />
                    </div>
                    <div
                    ...
                    >
                        <img
                            src="{{ asset('img/logo/media-indonesia.png') }}"
                            alt=""
                        />
                    </div>
                    <div class="col-4 sponsor-list">
                        <img
                            src="{{ asset('img/logo/radar-jogja.png') }}"
                            alt=""
                        />
                    </div>
                </div>
