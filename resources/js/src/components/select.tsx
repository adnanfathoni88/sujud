...
function Select({ name, label, options, defaultValue, error, ...rest }: { error?: string, name: string, label: string, options: { nama: string, id: number }[], defaultValue: number }, ref) {
	return (
		<div>
