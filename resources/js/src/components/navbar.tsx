        ...
        <Popover>
            <PopoverButton className="block font-semibold rounded-full border-2 overflow-hidden border-white focus:outline-none">
                {profileImage ? (
                    ...
                    <div className="w-9 h-9 flex items-center justify-center text-sky-600 bg-white">
                        <FaUser size={18} />
                    </div>
                )}
            </PopoverButton>
                ...
                >
                    <div className="p-3">
                        ...
                        >
                            ...
                            <p className="text-black/50">
                                Lihat dan kelola apa saja pesanan kamu.
                            </p>
                        </Link>
                    </div>
                    ...
                    <div className="p-3 border-t-2 border-black">
                        <button
                            ...
                            className="text-start block rounded-lg py-3 px-3 transition hover:bg-black/5 w-full"
                        >
                            ...
                            .with(true, () => (
                                <>
                                    <li>
                                        <Link
                                            to="/cart"
                                            className="mx-3 block px-3 py-3 font-semibold rounded-full bg-white text-sky-600 hover:bg-sky-500/25 hover:text-white transition-all "
                                        >
                                            <MdShoppingCart />
                                        </Link>
                                    </li>
