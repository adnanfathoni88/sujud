		...
		<header className="sticky top-0 z-999 flex w-full bg-white drop-shadow-1 dark:bg-boxdark dark:drop-shadow-none">
			<div className="flex flex-grow items-center justify-between px-4 py-4 shadow-2 md:px-6 2xl:px-11">
						...
						? (
							<div className="flex items-center gap-2 sm:gap-4 lg:hidden">
								...
								<button
									...
									onClick={ (e) => {
										e.stopPropagation();
										props.setSidebarOpen instanceof Function && props.setSidebarOpen(!props.sidebarOpen);
									} }
						...
						<form action="https://formbold.com/s/unique_form_id" method="POST">
							<div className="relative">
								...
								<input
									...
									className="w-full bg-transparent pl-9 pr-4 text-black focus:outline-none dark:text-white xl:w-125 border-none focus:border-none"
				...
				<div className="flex items-center gap-3 2xsm:gap-7">
					...
					{ Boolean(data?.response) && <DropdownUser user={data?.response} /> }
				</div>
			</div>
		</header>
	);
