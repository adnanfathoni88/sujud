        ...
        <div className="dark:bg-boxdark-2 min-h-[100vh]">
            ...
            <div
                className={twMerge(
                    ...
                    data?.response?.role_id == 2 ? "pt-32" : "mt-10"
                )}
            >
                <div className="flex px-4 justify-between flex-col sm:flex-row sm:items-center">
                    <div>
                        <h3 className="text-base font-semibold leading-7 text-gray-900 dark:text-zinc-100">
                            Profile
                        </h3>
                        <p className="mt-1 max-w-2xl text-sm leading-6 text-gray-500 dark:text-zinc-300">
                            Detail informasi profile.
                        </p>
                    </div>
                    {data?.response && (
                        <ProfileUpdate profile={data.response} />
                    )}
                </div>
                        ...
                        <div className="mt-6 border-t px-4">
                            <dl>
                                <div className="py-3 sm:grid sm:grid-cols-3 sm:gap-4">
                                    <dt className="text-sm font-medium leading-6 text-gray-900 dark:text-zinc-100">
                                        Full name
                                    </dt>
