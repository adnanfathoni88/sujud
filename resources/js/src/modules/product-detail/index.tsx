...
import { useDeleteProductById, useGetProductById } from "../../adapters/hooks/useProducts"
...
export default function ProductDetailModule() {
	...
	return (
		<>
			...
			<hr />
			{data && (
				<button className="bg-red-600 p-3 text-white" onClick={handleDelete}>DELETE</button>
			)}
			<pre>
